...
* Primeira extensão criada e publicada do [VSCode](https://marketplace.visualstudio.com/items?itemName=LinguagemEgua.linguagem-egua-vscode) do projeto [Egua](https://egua.tech/) - [Repositório do projeto](https://github.com/DesignLiquido/delegua-vscode).
