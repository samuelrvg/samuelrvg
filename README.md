...
* Primeira extensão criada e publicada do [VSCode](https://marketplace.visualstudio.com/items?itemName=LinguagemEgua.linguagem-egua-vscode) do projeto [egua](https://egua.tech/) no [repositório](https://github.com/eguatech/egua-extensao-vscode).
